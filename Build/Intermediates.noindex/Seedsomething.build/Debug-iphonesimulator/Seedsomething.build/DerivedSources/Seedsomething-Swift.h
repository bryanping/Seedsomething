...
#ifndef SEEDSOMETHING_SWIFT_H
#define SEEDSOMETHING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Seedsomething",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Seedsomething11AppDelegate")
...
SWIFT_CLASS("_TtC13Seedsomething11AuthManager")
...
@interface AuthManager (SWIFT_EXTENSION(Seedsomething)) <ASAuthorizationControllerPresentationContextProviding>
...
@interface AuthManager (SWIFT_EXTENSION(Seedsomething)) <ASAuthorizationControllerDelegate>
...
SWIFT_CLASS("_TtC13Seedsomething12PlantManager")
...
@interface PlantManager (SWIFT_EXTENSION(Seedsomething)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC13Seedsomething13SceneDelegate")
